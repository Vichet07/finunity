...
- Claude Code, using select skills from [awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills):
  - **test-driven-development** — write and verify tests before implementation, to avoid over-trusting AI-generated code
  - **mcp-builder** — used if/when the debate agents (Advocate/Skeptic/Synthesis) or sensor integration are exposed as MCP tools
